defmodule LiveStudy.Volunteers do
  @moduledoc """
  ...
  def subscribe() do
    Phoenix.PubSub.subscribe(LiveStudy.PubSub, "volunteers")
  end

  def broadcast({:ok, volunteer}, tag) do
    Phoenix.PubSub.broadcast(LiveStudy.PubSub, "volunteers", {tag, volunteer})
